...
/*A function to Get a specific pin masked interrupt status*/
GPIO_CheckType GPIO_GetMaskedInterruptStatus(uint8_t GroupId,GPIO_IntStatus *IntStatusPtr);
/*A function to Get a specific pin raw interrupt status*/
GPIO_CheckType GPIO_GetRawInterruptStatus(uint8_t GroupId,GPIO_IntStatus *IntStatusPtr);
/*A function to Toggle state of a specific group*/
GPIO_CheckType GPIO_Toggle(uint8_t GroupId);
#endif
